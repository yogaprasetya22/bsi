        ...
        <div className="w-full bg-gray-100 p-5 rounded-lg shadow-md">
            ...
            <form onSubmit={submitForm} className="flex flex-col gap-3">
                <div className="flex flex-col gap-1">
                    ...
                    />
                    <InputError message={errors.no_surat} className="mt-2" />
                </div>
                <div className="flex flex-col gap-1">
                    ...
                    <textarea
                        ...
                        ref={textAreaRef}
                        className="w-full rounded-md border border-gray-500 p-2 h-20 resize-none overflow-y-hidden"
                    ></textarea>
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <input
                        ...
                        className=" hidden"
                    />
                    {/* <Error message={errors.file} className="mt-2" /> */}
                </div>
                <div className="flex flex-col gap-1">
                    <button
                        type="submit"
